...
<div class="max-w-7xl mx-auto p-6 space-y-6">
  ...
  <div class="flex items-center justify-between animate-fadeup">
    <div>
      <h2 class="text-2xl font-bold tracking-tight text-slate-900">Counselors</h2>
      <p class="text-sm text-slate-600">Manage counselor profiles and weekly availability.</p>
    </div>
  ...
  {{-- Table card --}}
<div class="bg-white rounded-2xl shadow-sm border border-slate-200/70 overflow-hidden animate-fadeup">
