...
<div class="space-y-6">
  ...
  <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-3">
    <div>
      ...
      <select name="counselor_id" class="w-full rounded-xl border-slate-300 focus:ring-2 focus:ring-sky-500">
    ...
    <div>
      ...
      <select name="month" class="w-full rounded-xl border-slate-300 focus:ring-2 focus:ring-sky-500">
    ...
    <div>
      ...
      <select name="year" class="w-full rounded-xl border-slate-300 focus:ring-2 focus:ring-sky-500">
        <option value="">All</option>
        @foreach($years as $y)
  ...
  <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
    <div class="px-4 py-3 border-b border-slate-200 flex items-center justify-between">
      <div class="text-sm font-semibold text-slate-800">Non-Technical (All)</div>
      <div class="text-xs text-slate-500">Showing {{ $rows->firstItem() }}–{{ $rows->lastItem() }} of {{ $rows->total() }}</div>
    </div>
