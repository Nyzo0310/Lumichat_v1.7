{{-- resources/views/admin/diagnosis-reports/pdf.blade.php --}}
@php
...
<body>
  ...
  <table>
    ...
    <tbody>
      ...
      @empty
        <tr><td colspan="5" class="small" style="text-align:center; padding:16px 0;">No diagnosis reports found.</td></tr>
      @endforelse
    </tbody>
  </table>
